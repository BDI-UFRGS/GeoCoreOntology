 ...
 * [geocore.yml](geocore.yml)
     * Determines how your purl.obolibrary.org/obo/geocore/ redirects will be handled
     ...
     * Paste in the contents of [geocore.yml](geocore.yml)
 ...
 * [geocore.md](geocore.md)
     ...
     * Paste in the contents of [geocore.md](geocore.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
